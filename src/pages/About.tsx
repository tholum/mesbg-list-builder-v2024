    ...
    <Stack direction="row" gap={5} flexWrap="wrap">
      <Stack gap={2} sx={{ maxWidth: "78ch" }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "18px" }}>
          ...
          Marcel Hollink. We strive to create the best list builder out there by
          creating an easy to navigate and simple to use application.
        </Typography>
        <Typography variant="body1" sx={{ fontSize: "18px" }}>
        ...
        <Typography variant="body1" sx={{ fontSize: "18px" }}>
          ...
          are not interested in making the app paid or adding adverts (which
          would disrupt the user experience). There is no need for you to pull
          your wallet to build your army list.
        </Typography>
        <Typography variant="body1" sx={{ fontSize: "18px" }}>
          ...
          your corrections via pull request. You can also inform us of any
          errors by email:{" "}
