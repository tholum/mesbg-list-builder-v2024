  ...
  <Stack direction="row" gap={5} flexWrap="wrap">
    <Stack gap={2} sx={{ maxWidth: "78ch" }}>
      ...
      <Typography variant="body1" sx={{ fontSize: "18px" }}>
        ...
        ). If you&apos;d like to help you can fork the repository and provide
        your corrections via pull request. You can also inform us of any errors
        by email:{" "}
      ...
      <Stack component="ul" sx={{ listStyle: "none", pl: 0 }} gap={1}>
        <Box component="li">
          <Typography>
            ...
            account. This will allow users with an account to save their rosters
            and match history on our servers and allows them to sync more easily
            between their computer and mobile device while also reducing the
            risk of losing their browser storage.
          </Typography>
        </Box>
        <Box component="li">
          <Typography>
    ...
    <Stack sx={{ maxWidth: "64ch" }}>
      ...
      <Typography variant="body1" sx={{ fontSize: "16px" }}>
        <Stack component="ul" sx={{ listStyle: "none", pl: 0 }} gap={1}>
          ...
          <Box component="li">
            <strong>Custom-made profile cards</strong> for all models across The
            Lord of the Rings, The Hobbit and expansions.
          </Box>
          <Box component="li">
            <strong>PDF print-out</strong> for your list, providing all profile
            stats, special rules, magical powers, Might/Will/Fate/Wounds
            tracking etc.
          </Box>
          <Box component="li">
            <strong>Game Mode</strong> which provides digital stat trackers as
            an interactive alternative to the PDF print-out, allowing you to;
            <ul>
              <Box component="li">
          ...
          <Box component="li">
            <strong>All relevant roster information available</strong> in the
            drawer on the right, which collapses for Mobile users.
          </Box>
          <Box component="li">
            Alerts providing{" "}
            <strong>notifications for illegal roster combinations</strong> and
            required models.
          </Box>
          <Box component="li">
            <strong>Match History</strong> which allows you to keep track of
            your matches from Game Mode, as well as being able to add matches
            manually for when you use the PDF print-out.
            <ul>
              <Box component="li">
          ...
          <Box component="li">
            ...
            <strong>provides import/export</strong> options to keep your data
