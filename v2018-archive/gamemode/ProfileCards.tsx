...
import hero_constraint_data from "../../src/assets/data/hero_constraint_data.json";
import { UnitProfileCard } from "../../src/components/common/images/UnitProfileCard.tsx";
import { useRosterBuildingState } from "../../src/state/roster-building";
import {
  isSelectedUnit,
  MesbgDataTypes,
} from "../../src/types/mesbg-data.types.ts";
...
export const ProfileCards = () => {
  ...
  const getExtraProfilesForHero = (hero: MesbgDataTypes) => {
